...
wwwdisk="/var/www/apache2-default/weather/kml/nam_west"
www="http://hypercube.telascience.org/weather/kml/nam_west/"
...
function doplot {
	...
	gribfile="westarw.t${run}z.awpreg${timee}.tm00.grib2"
