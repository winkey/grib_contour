...
wwwdisk="/home/rush/winkey/public_html//kml/rtma_conus"
www="atmos.ucsd.edu//kml/rtma_conus"
...
#NGRID	^L[A-Z][AM]A98 KWBR .* !grib2/ncep/RTMA/#227/([0-9]{8})([0-9]{2})00F000/(DRCT|SPED|UREL|VREL|TMPK|DWPK)/
#	EXEC	/usr/local/bin/rtma_conus.sh data/ngrid/rtma/227/\1\2.\2.\3.grib2 \2 \3
