...
wwwdisk="/home/rush/public_html/weather/kml/rtma_nhem"
www="http://winkey.org/weather/kml/rtma_nhem"

#NGRID	^L[A-Z][AM]A98 KWBR .* !grib2/ncep/RTMA/#201/([0-9]{8})([0-9]{2})00F000/(DRCT|SPED|UREL|VREL|TMPK|DWPK)/
#	EXEC	/usr/local/bin/rtma_nhem.sh data/ngrid/rtma/201/\1\2.\2.\3.grib2 \2 \3
